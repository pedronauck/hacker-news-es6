...
var Feed = require('./modules/feed.js').default;
...
},{"./modules/feed.js":31,"6to5/polyfill":28}],2:[function(require,module,exports){
require("es6-symbol/implement");
require("es6-shim");
require("regenerator/runtime");

},{"es6-shim":3,"es6-symbol/implement":4,"regenerator/runtime":27}],3:[function(require,module,exports){
(function (process){
...
},{"_process":29}],4:[function(require,module,exports){
'use strict';
...
},{"./lib/6to5/polyfill":2}],29:[function(require,module,exports){
...
var HackerNews = require('./hacker-news.js').default;
...
var Feed = function() {
  ...
  Object.defineProperties(Feed.prototype, {
    ...
    bindSearch: {
      ...
      value: function() {
        var _this2 = this;
        var _search = _('.search-input');

        _search.on('input', function(ev) {
          var _value = ev.target.value;
          var _regexp = new RegExp(_value, 'i');
          var _filteredItems = _this2.items.filter(function(_regexp) {
            return function(item) {
              return _regexp.test(item.title);
            };
          }(_regexp));

          _this2.renderList(_filteredItems);
        });
      }
    },
    ...
    fetchItems: {
      ...
      value: function(cb) {
        var _this3 = this;
        var _newsService = new HackerNews();
        var _news = _newsService.fetchNews();

        _news.success(function(data) {
    ...
    renderList: {
      ...
      value: function(items) {
        var _feed2 = _('.feed');
        var _list = items.map(function(item) {
...
},{"./hacker-news.js":32,"jquery":30}],32:[function(require,module,exports){
"use strict";
var _ = require('jquery');
...
var HackerNews = function() {
  ...
  Object.defineProperties(HackerNews.prototype, {
    fetchNews: {
      writable: true,

      value: function() {
        var _url = "" + this.apiUrl + "/page";
